  ...
  TC.Localization.register('en', {
    ...
    ui: {
      ...
      packs: {
        ...
        unavailable: 'Pack installer unavailable',
        read_error: 'Could not read the selected file',
        unknown_error: 'Unknown pack install error',
        empty_error: 'Selected pack file is empty',
        storage_error: 'Could not update pack storage',
        load_error: 'Some installed packs could not be loaded',
        not_installed: 'Pack is not installed',
      },
      net: {
