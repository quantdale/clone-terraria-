  ...
  TC.Localization.register('en', {
    ...
    ui: {
      ...
      packs: {
        ...
        remove: 'Remove',
        installed: 'Installed',
        install_ok: 'Installed {id}',
        install_unchanged: '{id} already installed',
        install_failed: 'Install failed: {reason}',
        remove_ok: 'Removed {id}',
        remove_failed: 'Remove failed: {reason}',
